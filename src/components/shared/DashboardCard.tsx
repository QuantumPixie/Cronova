...
export default function DashboardCard({
  ...
  return (
    <ErrorBoundary>
      ...
      >
        <div
          className='bg-white rounded-lg border border-[#E3BAB3] shadow-sm transition-all duration-200 ease-in-out hover:shadow-md hover:border-[#B76E79]'
          ...
          <div className='p-6'>
            <div className='flex items-start space-x-4'>
              <div className='flex-shrink-0'>
                <div
                  className='p-3 bg-gradient-to-r from-[#E3BAB3] to-[#B76E79] rounded-lg group-hover:from-[#B76E79] group-hover:to-[#E3BAB3] transition-colors'
                  data-testid='dashboard-card-icon-container'
                >
                  <Icon
