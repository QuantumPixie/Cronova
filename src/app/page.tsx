    ...
    <div className='min-h-screen bg-gradient-to-b from-[#F5F2F2] to-[#F7E8E8]'>
      ...
      <main>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-24 relative'>
          ...
          <div className='absolute bottom-10 right-10 text-[#FFD700] opacity-30'>
            <Sparkles className='w-8 h-8' />
          </div>
        ...
        <div className='bg-gradient-to-b from-white to-[#F7E8E8] py-24 relative'>
          ...
          <div className='absolute bottom-0 right-1/4 text-[#FFD700] opacity-20'>
            <Sparkles className='w-6 h-6' />
          </div>
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            ...
            <div className='mt-20'>
              <div className='grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3'>
                {/* Symptom Tracking */}
                <div className='flex flex-col items-center p-6 rounded-lg border-2 border-[#800020] shadow-md hover:shadow-lg transition-all duration-200 bg-white relative group'>
                  <div className='absolute -top-2 -right-2 text-[#FFD700] opacity-0 group-hover:opacity-100 transition-opacity duration-300'>
                ...
                <div className='flex flex-col items-center p-6 rounded-lg border-2 border-[#800020] shadow-md hover:shadow-lg transition-all duration-200 bg-white relative group'>
                  ...
                  <div className='p-3 bg-[#E3BAB3] rounded-lg'>
                    <LineChart className='w-6 h-6 text-[#800020]' />
                  </div>
                  <h3 className='mt-4 text-lg font-medium text-[#800020]'>
                    AI-Powered Insights
                  </h3>
